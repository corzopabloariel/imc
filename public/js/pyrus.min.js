 ...
 */
Pyrus = function( e = null, dataPYRUS = null ) {
    ...
    this.inputString = function(OBJ_elemento,STR_nombre,STR_type,STR_class,OBJ_funcion = null, placeholder = "", multiple = null) {
        ...
        if(OBJ_elemento.FIELDSET !== undefined)
            return `<fieldset><legend>${placeholder == "" ? OBJ_elemento.NOMBRE : placeholder}</legend><input ${inputData} name="${name}" id="${STR_nombre}" class="${STR_class}" type="${STR_type}" placeholder="${placeholder == "" ? OBJ_elemento["NOMBRE"] : placeholder}" /></fieldset>`;
        return `<input ${inputData} name="${name}" id="${STR_nombre}" class="${STR_class}" type="${STR_type}" placeholder="${placeholder == "" ? OBJ_elemento["NOMBRE"] : placeholder}" />`;
    }
    ...
    this.select = function(OBJ_elemento,STR_nombre,STR_class,OBJ_funcion,OBJ_datos = null,value = null) {
		...
		let return_STR = `<select ${(OBJ_elemento["MULTIPLE"] ? "multiple='true'" : "data-allow-clear='true'")} ${(OBJ_elemento["DISABLED"] ? "disabled='true'" : "")} ${(OBJ_elemento["NECESARIO"] ? "required='true'" : "")} ${STR_funcion} name="${STR_nombre}" id="${STR_nombre}" class="${STR_class} select__2" data-placeholder="${OBJ_elemento["NOMBRE"]}">`;
